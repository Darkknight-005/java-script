/*
there are two kinds of operators bitwise logical and bitwise shift operstors 
...
Bitwise XOR 	                    a ^ b 	            Returns a zero in each bit position for which the   
                                                        corresponding bits are the same. [Returns a one in each bit position for which the corresponding bits are different.]
...
/*bitwise opertor use bite for logical test
like 00000000,00000001,00000010 etc.

if we write code the bitwise operators convert them in bit and then decide logic for true or false the execute it right now i don't have example how to explain.*/